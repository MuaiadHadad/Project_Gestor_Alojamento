                        ...
                        <div class="col-sm-16">
                            <div class="list_detail_1l clearfix" >
                                <div class="list_detail_1l1 clearfix" >
                                    ...
                                    <h5 STYLE="padding-right: 20px"  class="mgt"><a class="button mgt" href="/Gestor/{{ $dadoscasa->idnow }}/AprovarCasa">Aprovar</a></h5>
                                    <h5 style="float: left; padding-left: 73%;" class="mgt"><a type="submit"  class="button mgt" href="/Gestor/{{ $dadoscasa->idnow }}/ReprovarCasa">Reprovar</a></h5>
                                </div>
