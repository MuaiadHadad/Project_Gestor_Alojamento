                ...
                <div class="row">
                    ...
                    @if(isset($DadosCasaAtive))
                        @foreach($DadosCasaAtive as $CasaEdit)
                            <form action="/Senhorio/{{$CasaEdit->idnow}}/editQuartoQ" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="submit_1 clearfix">
                                    ...
                                    <div class="submit_1i clearfix">
                                        ...
                                        <div class="submit_2i clearfix">
                                            <h5>
                                                <input {{ $CasaEdit->roupa_de_cama == 1 ? 'checked' : '' }} name="roupa_de_cama_" type="checkbox">
                                                <span class="span_1">roupa de cama</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->cama == 1 ? 'checked' : '' }} name="cama_" type="checkbox">
                                                <span class="span_1">cama</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->mesa_cabeceira == 1 ? 'checked' : '' }} name="mesa_cabeceira_" type="checkbox">
                                                <span class="span_1">mesa cabeceira</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->Candeeiro_de_mesa_do_estudo == 1 ? 'checked' : '' }} name="Candeeiro_de_mesa_do_estudo_" type="checkbox">
                                                <span class="span_1">Candeeiro de mesa do estudo</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->Mesa_do_estudo == 1 ? 'checked' : '' }} name="Mesa_do_estudo_" type="checkbox">
                                                <span class="span_1">Mesa do estudo</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->Janelas == 1 ? 'checked' : '' }} name="Janelas_" type="checkbox">
                                                <span class="span_1">Janelas</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->Varanda == 1 ? 'checked' : '' }} name="Varanda_" type="checkbox">
                                                <span class="span_1">Varanda</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->Armario == 1 ? 'checked' : '' }} name="Armario_" type="checkbox">
                                                <span class="span_1">Armário</span>
                                            </h5>
                                            <h5>
                                                <input {{ $CasaEdit->Casa_de_banho_privativa == 1 ? 'checked' : '' }} name="Casa_de_banho_privativa_" type="checkbox">
