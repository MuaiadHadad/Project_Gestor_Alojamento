...
<head>
    ...
    <link rel="stylesheet" href="/Style_page_senhorio/Chat_Style.css">
    <!-- /Css adicional -->
...
<main id="primary" class="main-section">
    <section class="module module-page--header site-header--image-bg" style="height: 280px ">
        <div class="page-title">
            ...
            <div class="breadcrumbs"><a href="/Aluno" rel="v:url" property="v:title">Aluno</a> / <span class="current">Chat</span></div>
            <!-- .breadcrumbs -->
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card_chat chat-app">
                            ...
                            <div class="chat">
                                ...
                                <form action="/chat/{{ $dadosgeral->idchat }}/send-message" method="post" enctype="multipart/form-data">
                                    @csrf
...
<footer class="module module-site-footer">
    ...
    <script type="text/javascript" src="/Style_page_senhorio/Chat_JS.js"></script>
