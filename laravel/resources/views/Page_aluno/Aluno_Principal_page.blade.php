...
<main id="primary" class="main-section">
    <section class="module module-page--header site-header--image-bg" style="height: 310px ">
        <div class="page-title">
            ...
            <div class="breadcrumbs"><a href="/" rel="v:url" property="v:title">Alojamentos</a> / <span class="current">Aluno</span></div>
            <!-- .breadcrumbs -->
        </div>
        ...
        <section class="module module--list" id="Lista_apartamento">
            ...
            <section class="table__header">
                <div class="center_home_1i1 clearfix">
                    <h5 style="visibility: hidden" class="mgt text-center"><a class="button_1 block mgt" ><i class="fa fa-home" aria-hidden="true"></i> Adicionar Propriedade</a></h5>
                </div>
                    ...
                    @if($favoritos !=null)
                        @foreach($favoritos as $dadosfavoritos)
                            <tr>
                                ...
                                <td> {{ $dadosfavoritos->Tipo }} </td>
                                <td> {{ $dadosfavoritos->data_fim }}</td>
                                <td> {{ $dadosfavoritos->Preço }}€</td>
                                <td>
                                    <a href="inicio/{{ $dadosfavoritos->idnow }}/quarto" class="fa fa-eye fa-2x"></a>
                                </td>
                    ...
                    @if($feveritosCasa !=null)
                        @foreach($feveritosCasa as $dadosfavoritosC)
                            <tr>
                                ...
                                <td> {{ $dadosfavoritosC->Tipo }} </td>
                                <td> {{ $dadosfavoritosC->Data_fim }}</td>
                                <td> {{ $dadosfavoritosC->Preço }}€</td>
                                <td>
                                    <a href="inicio/{{ $dadosfavoritosC->idcasa }}/casa" class="fa fa-eye fa-2x"></a>
                                </td>
